...
<body class="bg-gray-100 font-sans antialiased">
    ...
    <nav class="bg-blue-900 p-4">
        <div class="max-w-7xl mx-auto flex justify-between items-center">
            ...
            <div class="space-x-4">
                <a href="{{ route('teacher.signup') }}" class="text-white hover:bg-blue-700 px-4 py-2 rounded">Students</a>
                <a href="{{ route('teacher.signup') }}" class="text-white hover:bg-blue-700 px-4 py-2 rounded">Add Student</a>
    ...
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between">
        ...
        <div class="text-center md:text-left md:w-1/2">
            ...
            <a href="{{ route('teacher.signup') }}" class="mt-8 inline-block bg-green-600 text-white py-2 px-6 rounded hover:bg-green-700">Get Started</a>
        </div>
    ...
    <section class="bg-blue-700 text-white py-16">
        <div class="max-w-7xl mx-auto text-center">
            ...
            <a href="{{ route('teacher.signup') }}" class="bg-green-600 text-white py-3 px-8 rounded hover:bg-green-700">Get Started</a>
        </div>
    </section>
